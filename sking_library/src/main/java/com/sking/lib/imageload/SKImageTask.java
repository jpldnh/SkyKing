...
public class SKImageTask extends SKObject {
    ...
    public SKImageTask(ImageView imageView, Object context) {
     ...
     * @param context 使用场合
     */
    public SKImageTask(ImageView imageView, URL url, Object context) {
     ...
     * @param context 使用场合
     */
    public SKImageTask(ImageView imageView, String path, Object context) {
        this(imageView, context);
        this.path = path;
    }
     ...
     * @param context 使用场合
     */
    public SKImageTask(ImageView imageView, URL url, Object context, SKSize size) {
        this(imageView, url, context);
        this.mSize = size;
    }
    ...
    private static class EventHandler extends Handler {
        private SKImageTask imageTask;

        public EventHandler(SKImageTask imageTask, Looper looper) {
            super(looper);
