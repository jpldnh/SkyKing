...
public class SKRSuccessTickView extends View {
    ...
    public SKRSuccessTickView(Context context) {
        super(context);
        init();
    }

    public SKRSuccessTickView(Context context, AttributeSet attrs){
        super(context,attrs);
        init();
    }
    ...
    private void init () {
        mPaint = new Paint();
        mPaint.setColor(getResources().getColor(R.color.colorPrimary));//设置画笔颜色为蓝色
