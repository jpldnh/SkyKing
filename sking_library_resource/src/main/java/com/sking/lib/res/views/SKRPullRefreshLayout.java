...
import com.sking.lib.res.classes.SKRPullRefresh;

/**
 * Created by Zhao jw on 2016/12/19.
 */

public class SKRPullRefreshLayout extends SKRPullRefresh {
    ...
    public SKRPullRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        setRefreshView(R.layout.skr_layout_pull_down_refresh, new RefeshListener());
        setLoadmoreView(R.layout.skr_layout_pull_down_loadmore, new LoadmoreListener());
