...
public abstract class SKRScrollerProxy {

	public static SKRScrollerProxy getScroller(Context context) {
	...
	@TargetApi(9)
	private static class GingerScroller extends SKRScrollerProxy {
	...
	private static class PreGingerScroller extends SKRScrollerProxy {
