...
public interface SKRIPhotoView {
    /**
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(SKRPhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(SKRPhotoViewAttacher.OnPhotoTapListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(SKRPhotoViewAttacher.OnViewTapListener listener);
