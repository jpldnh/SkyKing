 ...
 * @author YANG ZT
 */
public class SKRPullRefresh extends ViewGroup {
    ...
    public SKRPullRefresh(Context context) {
        this(context, null);
    }

    public SKRPullRefresh(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    /**
     * 加载成功 <b>(该方法会调用{@links stopLoadmore())
     */
    ...
    /**
     * 加载失败<b>(该方法会调用{@links stopLoadmore())
     */
    ...
    public interface OnStartListener {
         ...
         * @param v
         */
        public void onStartRefresh(SKRPullRefresh v);
         ...
         * @param v
         */
        public void onStartLoadmore(SKRPullRefresh v);
    }
