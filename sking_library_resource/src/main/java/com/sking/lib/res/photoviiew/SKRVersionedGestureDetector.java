...
public abstract class SKRVersionedGestureDetector {
	static final String LOG_TAG = "SKRVersionedGestureDetector";
	OnGestureListener mListener;

	public static SKRVersionedGestureDetector newInstance(Context context,
                                                          OnGestureListener listener) {
		final int sdkVersion = Build.VERSION.SDK_INT;
		SKRVersionedGestureDetector detector = null;
	...
	private static class CupcakeDetector extends SKRVersionedGestureDetector {
