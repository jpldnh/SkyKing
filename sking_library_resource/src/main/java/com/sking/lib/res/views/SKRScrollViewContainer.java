...
/**
 * 侧滑删除view
 * 包含两个ScrollView的容器(改进)
 */
public class SKRScrollViewContainer extends RelativeLayout {
	/**
	 * 自动上滑
	 */
	...
	public SKRScrollViewContainer(Context context) {
		super(context);
		init();
	}

	public SKRScrollViewContainer(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public SKRScrollViewContainer(Context context, AttributeSet attrs, int defStyle) {
...
//		barHeight = YjGoUtil.dip2px(getContext(), 48);
	}
...
//		bottomView.layout(0, topView.getMeasuredHeight() + (int) mMoveLen + barHeight,
//		mViewWidth, topView.getMeasuredHeight() + (int) mMoveLen
//				+ bottomView.getMeasuredHeight() + barHeight);
	}
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (!isMeasured) {
			...
			if (hasSmartBar())
				mViewHeight = getMeasuredHeight() - barHeight;
			else
...
//			web = (HemaWebView) bottomView.findViewById(R.id.webview);
//			web.setOnTouchListener(new OnTouchListener() {
//
//				@Override
//				public boolean onTouch(View v, MotionEvent event) {
//					if (web.getScrollY() == 0 && mCurrentViewIndex == 1)
//						canPullDown = true;
//					else
//						canPullDown = false;
//					return false;
