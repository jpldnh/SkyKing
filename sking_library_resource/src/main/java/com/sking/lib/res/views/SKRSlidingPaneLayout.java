 ...
 * </p>
 */
public class SKRSlidingPaneLayout extends ViewGroup {
	...
	public SKRSlidingPaneLayout(Context context) {
		this(context, null);
	}

	public SKRSlidingPaneLayout(Context context, AttributeSet attrs) {
...
//			final float dy = y - mInitialMotionY;
	...
	interface SlidingPanelLayoutImpl {
		void invalidateChildRegion(SKRSlidingPaneLayout parent, View child);
	}

	static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
		public void invalidateChildRegion(SKRSlidingPaneLayout parent,
                                          View child) {
	...
	class AccessibilityDelegate extends AccessibilityDelegateCompat {
		...
		public void onInitializeAccessibilityNodeInfo(View host,
			...
			info.setClassName(SKRSlidingPaneLayout.class.getName());
			info.setSource(host);
		...
		public void onInitializeAccessibilityEvent(View host,
			...
			event.setClassName(SKRSlidingPaneLayout.class.getName());
		}
	...
	private class DisableLayerRunnable implements Runnable {
		...
		@Override
		public void run() {
			if (mChildView.getParent() == SKRSlidingPaneLayout.this) {
