 ...
 * 圆形图片
 * */
public class SKRRoundImageView extends ImageView {
	...
	private ColorStateList borderColor = ColorStateList
			.valueOf(SKRRoundedDrawable.DEFAULT_BORDER_COLOR);
	...
	public SKRRoundImageView(Context context) {
		super(context);
	}

	public SKRRoundImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SKRRoundImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setImageDrawable(Drawable drawable) {
		mResource = 0;
		mDrawable = SKRRoundedDrawable.fromDrawable(drawable);
		updateDrawableAttrs();
	...
	public void setImageBitmap(Bitmap bm) {
		mResource = 0;
		mDrawable = SKRRoundedDrawable.fromBitmap(bm);
		updateDrawableAttrs();
		super.setImageDrawable(mDrawable);
	}
	...
	private Drawable resolveResource() {
		...
		return SKRRoundedDrawable.fromDrawable(d);
	}
	...
	private void updateBackgroundDrawableAttrs(boolean convert) {
		if (mutateBackground) {
			if (convert) {
				mBackgroundDrawable = SKRRoundedDrawable
	...
	private void updateAttrs(Drawable drawable) {
		...
		if (drawable instanceof SKRRoundedDrawable) {
			((SKRRoundedDrawable) drawable).setScaleType(mScaleType)
